...
<body>
   ...
   <script src="bootstrap-4.3.1-dist/js/bootstrap.min.js"></script><!--js-->
        ...
        <form method="POST" action="ajouter-demande.php">
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="date" class="form-control" id="inputdatedeb4" name="dd" placeholder="Date de debut"></div>
            <div class="form-group col-md-6">
